...
RSpec.describe 'User show page', type: :system do
  let!(:user) do
    User.create(name: 'mallu', photo: 'https://example.com/profile.jpg', bio: 'Software Engineer')
    User.create(name: 'siddu', photo: 'https://example.com/profile.jpg', bio: 'Electrical Engineer')
  end
  ...
  it 'displays user information and posts' do
    visit user_path(user)
    expect(page).to have_content('siddu')
    expect(page).to have_content("Number of post: #{user.posts_counter}")
